...
def countries_detail(request,pk):
    try:
        ...
        return JsonResponse({'message': 'The country does not exist'}, status=status.HTTP_400_BAD_REQUEST)
    ...
    if request.method == 'GET':
        ...
        countries.delete()
        return JsonResponse({'message': 'Country was deleted sucessfully'}, status=status.HTTP_400_NO_CONTENT )
